...
return function($req, $res) {
    ...
    $pLitres = FormUtils::getPostString($req->body('paintLitres'));
    $pPrice = FormUtils::getPostString($req->body('paintPrice'));
...
//printing success message
    $res->redirect("/viewPaint?success=1&paintID=$paintID");
        }
}
?>